...
const englishByRussian: Record<string, string> = {
  ...
  "Ссылка недействительна": "This link is invalid",
  "Обновить ссылку календаря": "Rotate calendar link",
  "Создать приглашение": "Create invitation",
  "Подключение завершено": "Connection complete",
